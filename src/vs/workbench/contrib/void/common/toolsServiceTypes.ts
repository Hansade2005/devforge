...
export type ToolCallParams = {
	...
	'find_symbol': { query: string },
	'list_symbols_in_file': { uri: URI },
	'run_linter': { target: string },
}
...
export type ToolResultType = {
	...
	'web_search': { results: { title: string, url: string, snippet: string }[] },
	// ---
	...
	'find_symbol': { result: Array<{ name: string, kind: string, file: string, line: number, column: number }> },
	'list_symbols_in_file': { result: Array<{ name: string, kind: string, line: number, column: number }> },
	'run_linter': { result: any },
}
