...
export const voidTools
	...
	= {
		...
		web_search: {
			...
			params: {
				search_term: { description: `The search term to look up on the web. Be specific and include relevant keywords for better results. For technical queries, include version numbers or dates if relevant.` },
			},
		},
		...
		find_symbol: {
			name: 'find_symbol',
			description: 'Search for a function, class, or variable symbol by name or pattern across the codebase.',
			params: {
		...
		run_linter: {
			name: 'run_linter',
			description: 'Run a linter on a file or project and return the results.',
			params: {
				target: { description: 'The file or directory to lint.' }
			}
		},
